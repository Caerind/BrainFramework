...
void Application::Run(std::function<void()>&& loopFunction)
{
    // Our state
...
void Application::Init()
{
    ...
    mHwnd = ::CreateWindowW(mWc.lpszClassName, L"Dear ImGui DirectX11 Example", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, nullptr, nullptr, mWc.hInstance, nullptr);
